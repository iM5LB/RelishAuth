...
- Discord: `/notify option:on` or `/notify option:off`
...
**Player Commands**:
- `/password` - Manage account password (modal)
- `/session` - View/change session duration
- `/notify` - Toggle join notifications
...
- `/block username:Name from:1.2.3.4` - Block username from IP
- `/unblock username:Name from:1.2.3.4` - Unblock username/IP
- `/clearblocks username:Name` - Clear stored blocks
- `/setpassword username:Name` - Set password (modal)
- `/resetpassword username:Name` - Reset password
